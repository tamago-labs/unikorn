...
const steps = [
  {
    n: '01',
    title: 'Ingest folder',
    desc: 'AI scans your codebase — framework, routes, API endpoints, features, and README as ground truth.',
    icon: '📁',
  },
  {
    n: '02',
    title: 'Draft PRD',
    desc: 'AI generates a PRD with overview, users, use cases, and non-goals — every claim tagged with its source.',
    icon: '📄',
  },
  {
    n: '03',
  ...
  return (
    <section id="how-it-works" className="max-w-5xl mx-auto w-full px-6 py-16">
      ...
      <div className="relative mt-10">
        <div className="hidden sm:block absolute top-5 left-[12%] right-[12%] h-px bg-[#E5DEFA]" />
